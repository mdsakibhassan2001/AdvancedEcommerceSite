...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form method="POST" class="register-form outer-top-xs" role="form" action="{{ route('login') }}">
		...
		<div class="form-group">
		    ...
		    <input type="email" value="{{ old('email') }}" name="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
			@error('email')
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<form class="register-form outer-top-xs" method="POST" action="{{ route('register') }}" role="form">
        ...
        <div class="form-group">
		    ...
		    <input type="name" name="name" value="{{ old('name') }}" class="form-control unicase-form-control text-input" id="exampleInputEmail1" >
			@error('name')
				<span class="invalid-feedback" role="alert">
					<strong>{{ $message }}</strong>
				</span>
