...
<head>
        ...
        <link href="{{asset('backend')}}/lib/toastr/toastr.min.css" rel="stylesheet">
		...
		<div class="header-top-inner">
			...
			<div class="cnt-block">
				<ul class="list-unstyled list-inline">
					...
					<li class="dropdown dropdown-small">
						<a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">@if (session()->get('language') == 'bangla') ভাষা পরির্বতন করুন @else
                            Language
             ...
             <li class="active dropdown yamm-fw">
                ...
                @foreach ($category as $categorys)
                    ...
                    <li class="dropdown yamm mega-menu">
                        ...
                        @if (session()->get('language') == 'bangla')
                           <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">{{$categorys->category_name_bn}}</a>
                           @else
                           <a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">{{$categorys->category_name_en}}</a>
                        @endif
                                ...
                                <div class="yamm-content ">
                                    <div class="row">
                                        ...
                                        @php
                                              ...
                                              $subcategory=App\Models\SubCategory::where('category_id',$categorys->id)->orderBy('subcategory_name_en','ASC')->get();
