<div class="card user_menu" style="width: 18rem;">
    ...
    <ul class="list-group list-group-flush">
        <li class="list-group-item btn "> <a href="{{route('admin.dashboard')}}">Home</a></li>
        <li class="list-group-item btn "><a href="{{ route('admin.image')}}">Update Image</a> </li>
        <li class="list-group-item btn "><a href="{{ route('admin.passowrd')}}">Update Password</a> </li>
