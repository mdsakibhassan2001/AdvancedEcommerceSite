    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails">
                ...
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{asset($img->id)}}">
				...
				@endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							<h1 class="name">@if(session()->get('language')=='bangla') {{$product->product_name_bn}} @end  {{$product->product_name_en}} @endif</h1>
									...
									<div class="col-sm-9">
										<div class="stock-box">
											@if(session()->get('language')=='bangla')
												<span class="value">@if($product->product_qty == 0)  স্টক নেই @else স্টকে আছে @endif</span>
											 @else
												<span class="value">@if($product->product_qty == 0)  No Stock @else In Stock @endif</span>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										...
										@else
											<span class="price">$@if(session()->get('language')=='bangla'){{bn_price($product->selling_price)}} @else {{$product->selling_price}} @endif</span>
											<span class="price-strike">$@if(session()->get('language')=='bangla'){{bn_price($product->discount_price)}} @else {{$product->discount_price}} @endif</span>
										@endif
										</div>
									</div>
