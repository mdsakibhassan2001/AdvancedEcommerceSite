...
@php
	...
	function bn_price($str)
	{
		...
		$bangla=array('১','২','৩','৪','৫','৬','৭','৮','৯','0');
        ...
        <ul class="nav">
			...
			@foreach($categorys as $category)
				...
				<li class="dropdown menu-item">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="{{$category->category_icon}}" aria-hidden="true"></i>@if(session()->get('language')=='bangla') {{$category->category_name_bn}} @else {{$category->category_name_en}} @endif</a>
						...
						<li class="yamm-content">
							<div class="row">
									...
									@php
										...
										$subcategory=App\Models\SubCategory::where('category_id',$category->id)->orderBy('subcategory_name_en','ASC')->get();
								...
								@foreach ($subcategory as $subcategorys)
									<div class="col-sm-12 col-md-3">
										...
										@if(session()->get('language')=='bangla')
											<h2 class="title">{{$subcategorys->subcategory_name_bn}}</h2>
										@else
											<h2 class="title">{{$subcategorys->subcategory_name_en}}</h2>
										@endif
										@php

										$‍subsubcategorys=App\Models\SubsubCategory::where('subcategory_id',$subcategorys->id)->orderBy('subsubcategory_name_en','ASC')->get();
										...
										@foreach($‍subsubcategorys as $‍subsubcategory)
											...
											@if(session()->get('language')=='bangla')
											<li><a href="#">{{$‍subsubcategory->subsubcategory_name_bn}}</a></li>
											@else
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								...
								<div class="tag new">@if(session()->get('language')=='bangla') <span>নতুন</span> @else <span>new</span> @endif</div>
								@else

								<div class="sale-offer-tag"><span> @if(session()->get('language')=='bangla') {{bn_price(round($discount))}}% @else {{round($discount)}}% @endif</span></div>
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">
								@if($product->discount_price == null)
								@if(session()->get('language')=='bangla')<span class="price-before-discount">{{bn_price($product->selling_price)}}</span> @else <span class="price-before-discount">{{bn_price($product->selling_price)}}</span> @endif
								@else

									@if(session()->get('language')=='bangla') <span class="price">{{bn_price($product->discount_price)}}</span>
									@else  {{$product->discount_price}}  @endif

									@if(session()->get('language')=='bangla')<span class="price-before-discount">{{bn_price($product->selling_price)}}</span> @else <span class="price-before-discount">{{$product->selling_price}}</span> @endif
                                ...
                                <div class="row product-micro-row">
                                    ...
                                    <div class="col col-xs-7">
                                        <div class="product-info">
                                            ...
                                            <h3 class="name"><a href="#"> @if(session()->get('language')=='bangla') {{$product->product_name_bn}}  @else  {{$product->product_name_en}} @endif</a></h3>
                                            <div class="rating rateit-small"></div>
                                            <div class="product-price">
                                            	@if($product->discount_price == null)
                                                @if(session()->get('language')=='bangla')<span class="price-before-discount">{{bn_price($product->selling_price)}}</span> @else <span class="price-before-discount">{{bn_price($product->selling_price)}}</span> @endif
								...
								<div class="product-image">
									<div class="image">
										...
										@if($product->discount_price== null)
											...
											<div class="tag new"><span> @if(session()->get('language')=='bangla') {{bn_price(round($discount))}}% @else {{round($discount)}}% @endif</span></div>
				...
				<div class="product-slider">
					<div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
						...
						@endphp
							...
							@empty
							<h5 class="text-danger">Product no found</h5>
							@endforelse
